...
style window:
    ...
    background Image("gui/textbox1.png", xalign=0.5, yalign= 0.0)
...
screen chapter_next_button(title_text, sub_text):
    ...
    vbox:
        ...
        text title_text:
            ...
            size 80
            xalign 0.5
            at transform: # Animasi muncul perlahan
                alpha 0.0
    ...
    vbox:
        align (0.5, 0.9) 
        textbutton "NEXT >":
            text_font "Quicksand-Regular.ttf"
            text_size 30
            text_hover_color "#ffcc00" 
            action Return()
            at transform: # Tombol muncul paling akhir
                alpha 0.0
                pause 1.5
...
screen main_menu():
    ...
    # 2. Gambar Logo dari Figma
    add "images/RATIH_LOGO.png":
        xalign 0.04
        yalign 0.2
        zoom 1

    # 3. Tombol-tombol khusus Main Menu (Tidak mengganggu menu lain)
    vbox:
        xalign 0.1
        yalign 0.5   
        spacing 15   
        ...
        # Tombol Mulai
        imagebutton:
            idle "images/Frame 1.png"
            hover "images/Frame 2.png"
            action Start()
            focus_mask True 
            foreground Text("Mulai", font="Quicksand-Bold.ttf", size=30, xalign=0.5, yalign=0.5)
        ...
        imagebutton:
            ...
            focus_mask True
            foreground Text("Muat", font="Quicksand-Bold.ttf", size=30, xalign=0.5, yalign=0.5)
        ...
        imagebutton:
            ...
            focus_mask True
            foreground Text("Setting", font="Quicksand-Bold.ttf", size=30, xalign=0.5, yalign=0.5)
        ...
        imagebutton:
            ...
            focus_mask True
            foreground Text("Tentang", font="Quicksand-Bold.ttf", size=30, xalign=0.5, yalign=0.5)
        ...
        imagebutton:
            ...
            focus_mask True
            foreground Text("Keluar", font="Quicksand-Bold.ttf", size=30, xalign=0.5, yalign=0.5)
...
style main_menu_frame:
    ...
    background "gui/overlay/MAIN_MENU3.png"
...
style game_menu_outer_frame:
    ...
    background "gui/overlay/setting (1).png"
...
style confirm_frame:
    background Frame([ "gui/confirm_frame.png", "gui/frame3.png"], gui.confirm_frame_borders, tile=gui.frame_tile)
